    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className={clsx(
            "w-full max-w-md rounded-3xl p-8 relative",
        ...
        >
          ...
          <div className="space-y-4">
            <motion.button
              ...
              disabled={isLoading}
              className={clsx(
                "w-full py-4 rounded-2xl font-body font-semibold text-base flex items-center justify-center gap-3 transition-all",
                "bg-white text-gray-900 hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
              )}
            >
            ...
            <div className="relative flex justify-center text-sm">
              <span
                className={clsx(
                  "px-4 font-body",
                  theme === "dark"
                    ? "bg-[rgba(15,15,20,0.7)] text-white/60"
                    : "bg-[rgba(255,255,255,0.75)] text-black/60"
                )}
              >
